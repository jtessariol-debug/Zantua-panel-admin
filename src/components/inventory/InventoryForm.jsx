    ...
    <form onSubmit={handleSubmit} style={styles.form}>
      <div style={styles.section}>
        <div style={styles.sectionTitle}>
          {itemType === "product" ? "Datos comerciales" : "Datos operativos"}
        </div>
      ...
      <div style={styles.section}>
        <div style={styles.sectionTitle}>Control de stock</div>
        <div style={styles.gridThree}>
          ...
          <Field
            ...
            onChange={(value) => setForm((current) => ({ ...current, current_stock: value }))}
            type="number"
          />
          <Field
            label="Stock mínimo"
